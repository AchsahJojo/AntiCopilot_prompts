...
public class StarterGuess {
    ...
    public static int[] narrowRange(int minV, int maxV, int guess, int secret) {
        // check the guess against the secret to determine the new range using conditionals

        //and keep track of the minV and maxV values and update them as needed within the conditon

        // update the minV to narrow the range
